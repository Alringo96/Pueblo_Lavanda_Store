...
// Traemos solo los productos en preventa
$sql = "SELECT * FROM productos WHERE `pre-venta` = '1'";
...
<div class="container my-4">
    ...
    <div id="productos-pre" class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-4 mb-4 productos">
